//
//  PredatorImagePreview.swift
//  JP Apex Predators
//
//  Created by Oscar David Myerston Vega on 17/02/23.
//

import SwiftUI

struct PredatorImagePreview: View {
...
struct PredatorImagePreview_Previews: PreviewProvider {
    static var previews: some View {
      ...
      let predator = ApexPredator(id: 3, name: "Tyrannosaurus Rex", type: "land", movies: movies, movieScenes: [movieScene1, movieScene2], link: "https://jurassicpark.fandom.com/wiki/Tyrannosaurus_rex")

        PredatorImagePreview(predator: predator)
